...
<table width="98%" border="0" style="margin:20px;" class="ListCategory">
  ...
  <tr>
    <td>产品详情描述：（产品简介 产品特点 安装方式 接线定义 产品尺寸） ：</td>
    <td>
    ...
    <td>规格参数 ：</td>
    <td>
    <textarea name="specification" style="width:680px; height:320px; margin:8px 0;visibility:hidden;"><?php echo ($product["specification"]); ?></textarea>
    </td>
  </tr>
	<tr>
    <td>产品优势 ：</td>
    <td>
    <textarea name="productadvantages" style="width:680px; height:320px; margin:8px 0;visibility:hidden;"><?php echo ($product["productadvantages"]); ?></textarea>
    </td>
  </tr>
	<tr>
		<td>典型应用 ：</td>
		<td>
		<textarea name="typicalapplication" style="width:680px; height:320px; margin:8px 0;visibility:hidden;"><?php echo ($product["typicalapplication"]); ?></textarea>
		</td>
	</tr>
	<tr>
		<td>订购信息 ：</td>
		<td>
		<textarea name="productorder" style="width:680px; height:320px; margin:8px 0;visibility:hidden;"><?php echo ($product["productorder"]); ?></textarea>
		</td>
	</tr>
	<tr>
		<td>产品提问 ：</td>
		<td>
		<textarea name="productquestion" style="width:680px; height:320px; margin:8px 0;visibility:hidden;"><?php echo ($product["productquestion"]); ?></textarea>
		</td>
	</tr>
</table>
</DIV>
...
<table width="98%" border="0" style="margin:20px;" class="ListCategory">
  ...
  <tr>
	...
	<tr>
		<td>规格参数（英文）：</td>
		<td>
		<textarea name="especification" style="width:680px; height:320px; margin:8px 0;visibility:hidden;"><?php echo ($product["especification"]); ?></textarea>
		</td>
	</tr>
	<tr>
    <td>产品优势（英文） ：</td>
    <td>
    <textarea name="eproductadvantages" style="width:680px; height:320px; margin:8px 0;visibility:hidden;"><?php echo ($product["eproductadvantages"]); ?></textarea>
    </td>
  </tr>
	<tr>
    <td>典型应用（英文） ：</td>
    <td>
    <textarea name="etypicalapplication" style="width:680px; height:320px; margin:8px 0;visibility:hidden;"><?php echo ($product["etypicalapplication"]); ?></textarea>
    </td>
  </tr>
	<tr>
		<td>订购信息（英文） ：</td>
		<td>
		<textarea name="eproductorder" style="width:680px; height:320px; margin:8px 0;visibility:hidden;"><?php echo ($product["eproductorder"]); ?></textarea>
		</td>
	</tr>
	<tr>
		<td>产品提问（英文） ：</td>
		<td>
		<textarea name="eproductquestion" style="width:680px; height:320px; margin:8px 0;visibility:hidden;"><?php echo ($product["eproductquestion"]); ?></textarea>
		</td>
	</tr>
  </table>
</DIV>
